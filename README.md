...
A Garmin fēnix 6 Sapphire is my personal interface and 'on-board' dashboard of choice. It's sensor package array yields the myriad physiological metrics, telemetry *and* local environmental data I require to *fuzzily* estimate net pace and predicted finish time during a run.
