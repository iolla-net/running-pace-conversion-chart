...
A Garmin fēnix 6 Sapphire is my personal biometric interface and 'on-board' instrumentation. It's sensor array package yields the myriad physiological metrics, telemetry *and* local environmental data I require to *fuzzily* estimate net pace and predicted finish time during a run.
