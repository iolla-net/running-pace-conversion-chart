...
A Garmin fēnix 6 Sapphire is my personal interface and 'on-board' dashboard of choice. It's on-board sensor array yields the myriad physiological metrics, telemetry *and* local environmental data I require to *fuzzily* estimate net pace and predicted finish time during a run.
