...
A Garmin fēnix 6 Sapphire serves as my personal 'on-board' biometric interface. It's sensor array package yields the myriad physiological metrics, telemetry *and* local environmental data I require to *fuzzily* estimate net pace and predicted finish time during a run.
