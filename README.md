...
However, whenever I set out to beat a PR (particularly on a familiar route) I like to 'preflight' pace over distance more accurately in order to do so. [This simple static chart](http://wachilt.github.io/running-pace-conversion-chart/) allows me to quickly do just that.
